...
//! rustterm provides clearing, event (input) handling, styling, cursor movement, and terminal actions for both
//! Windows and UNIX systems.
//!
//! rustterm aims to be simple and easy to call in code. Through the simplicity of rustterm, you do not
...
//! see [Tested Terminals](https://github.com/shirdonl/rustterm/tree/zrzka/docs-update#tested-terminals)
//! for more info).
//!
//! ## Command API
//!
//! The command API makes the use of `rustterm` much easier and offers more control over when and how a
...
//! at the same time.
//!
//! rustterm offers the possibility to do this with `queue`.
...
//! use rustterm::{QueueableCommand, cursor};
//!
...
//! ```no_run
//! use std::io::{Write, stdout};
//! use rustterm::{queue, QueueableCommand, cursor};
//!
//! let mut stdout = stdout();
...
//! ```no_run
//! use std::io::{Write, stdout};
//! use rustterm::{ExecutableCommand, cursor};
//!
//! let mut stdout = stdout();
...
//! ```no_run
//! use std::io::{Write, stdout};
//! use rustterm::{execute, ExecutableCommand, cursor};
//!
//! let mut stdout = stdout();
