...
///
/// rustterm provides a set of commands,
...
pub trait Command {
    ...
    ///
    /// This method does not need to be accessed manually, as it is used by the rustterm's [Command Api](../#command-api)
    ...
    T: Write,
{
    ...
    /// use rustterm::{Result, QueueableCommand, style::Print};
    ///
    ///  fn main() -> Result<()> {
    ...
    T: Write,
{
    ...
    /// ```rust
    /// use std::io::{Write, stdout};
    /// use rustterm::{Result, ExecutableCommand, style::Print};
    ///
    ///  fn main() -> Result<()> {
