...
//!
//! ```no_run
//! use rustterm::event::{read, Event};
//!
//! fn print_events() -> rustterm::Result<()> {
//!     loop {
...
//!
//! use rustterm::event::{poll, read, Event};
//!
//! fn print_events() -> rustterm::Result<()> {
//!     loop {
...
//! ```
//!
//! Check the [examples](https://github.com/shirdonl/rustterm/tree/master/examples) folder for more of
//! them (`event-*`).
...
/// use std::time::Duration;
///
/// use rustterm::{event::poll, Result};
///
...
///
/// ```no_run
/// use rustterm::{event::read, Result};
///
...
/// use std::time::Duration;
///
/// use rustterm::{event::{read, poll}, Result};
///
/// fn print_events() -> Result<bool> {
///     loop {
