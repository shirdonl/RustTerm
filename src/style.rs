...
//!
//! use rustterm::{execute, Result};
//! use rustterm::style::{Print, SetForegroundColor, SetBackgroundColor, ResetColor, Color, Attribute};
//!
//! fn main() -> Result<()> {
//!     execute!(
//!         stdout(),
...
//! use std::io::{stdout, Write};
//!
//! use rustterm::{execute, Result, style::Print};
//! use rustterm::style::{SetAttribute, Attribute};
//!
//! fn main() -> Result<()> {
//!     execute!(
//!         stdout(),
...
///
/// ```no_run
/// use rustterm::style::{style, Color};
///
